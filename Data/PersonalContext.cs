...
public partial class PersonalContext : DbContext
{
    ...
    public virtual DbSet<ReporteConceptosBitacora> ReporteConceptosBitacoras { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ReporteConcepto>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasDefaultValueSql("(newsequentialid())");
            entity.Property(e => e.Autorizo).HasMaxLength(250);
            entity.Property(e => e.Cat).HasMaxLength(250);
            entity.Property(e => e.Concepto).HasMaxLength(250);
            entity.Property(e => e.Depto).HasMaxLength(250);
            entity.Property(e => e.Descripcion).HasMaxLength(250);
            entity.Property(e => e.Duracion).HasMaxLength(250);
            entity.Property(e => e.Fecha).HasMaxLength(250);
            entity.Property(e => e.FechaCreacion).HasColumnType("datetime");
            entity.Property(e => e.FechaModificacion).HasColumnType("datetime");
            entity.Property(e => e.IncEntrada).HasMaxLength(250);
            entity.Property(e => e.IncSalida).HasMaxLength(250);
            entity.Property(e => e.Matricula).HasMaxLength(250);
            entity.Property(e => e.Nombre).HasMaxLength(250);
            entity.Property(e => e.Quincena).HasMaxLength(250);
            entity.Property(e => e.Turno).HasMaxLength(250);
            entity.Property(e => e.UsuarioCreacion).HasMaxLength(50);
            entity.Property(e => e.UsuarioModificacion).HasMaxLength(50);
        ...
        modelBuilder.Entity<ReporteConceptosBitacora>(entity =>
        {
            entity.ToTable("ReporteConceptosBitacora");
            ...
            entity.HasOne(d => d.Organizacion).WithMany(p => p.ReporteConceptosBitacoras)
                .HasForeignKey(d => d.OrganizacionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ReporteConceptosBitacora_Organizacion");
        });
